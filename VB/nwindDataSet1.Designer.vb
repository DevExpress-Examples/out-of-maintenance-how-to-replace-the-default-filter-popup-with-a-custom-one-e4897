...
Namespace nwindDataSetTableAdapters
    ...
    Partial Public Class CustomerReportsTableAdapter
        ...
        Public Overridable Overloads Function Fill(ByVal dataTable As nwindDataSet.CustomerReportsDataTable) As Integer
        ...
        Public Overridable Overloads Function GetData() As nwindDataSet.CustomerReportsDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
